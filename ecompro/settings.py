...
# STATICFILES_DIRS should point to a directory within your project, not an absolute path.
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # This points to the 'static' directory in your project root
]
